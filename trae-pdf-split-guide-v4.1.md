...
> [!note] 部署概况（截至 v4.1）
> - 已完成分片的书籍：**8 本**（#8-#16），共约 **1112 个 PDF 文件**
> - 新增经验：书签层级修正、跨章假重叠消除、书签未覆盖内容独立分片
> - 涵盖 PDF 类型：扫描版(4本)、文本版(4本)、合并PDF(1本)
> - 涵盖书签情况：完整书签(5本)、无用书签(1本)、无书签(2本)
